...
public class red1A extends CommandOpMode {
    ...
    public void initialize() {
        ...
        SequentialCommandGroup path = new SequentialCommandGroup(
                ...
                new gotoCommand(follower, new Pose2D(DistanceUnit.INCH, 45, 35.6, AngleUnit.DEGREES, 180), 0.70, red), // slow down for better accuracy
                new gotoCommand(follower, new Pose2D(DistanceUnit.INCH, 21, 35.6, AngleUnit.DEGREES, 180), 0.70, red),
                new gotoCommand(follower, new Pose2D(DistanceUnit.INCH, 45, 35.6, AngleUnit.DEGREES, 135), 0.70, red),
